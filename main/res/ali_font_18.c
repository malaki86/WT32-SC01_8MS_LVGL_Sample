 ...
 * Size: 18 px
 * Bpp: 4
 * Opts: --font /root/hmi_esp32/hmi/aliph.ttf -r 0x20-0x7F --symbols 启明 --size 18 --format lvgl --bpp 4 --no-compress -o ali_font_18.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4964, .adv_w = 283, .box_w = 16, .box_h = 17, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 5100, .adv_w = 283, .box_w = 15, .box_h = 17, .ofs_x = 1, .ofs_y = -3}
};
